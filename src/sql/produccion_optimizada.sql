-- =====================================================================
-- LOGISTEIA - SCRIPT OPTIMIZADO PARA PRODUCCIÓN
-- Solo incluye las tablas y campos que se usan en el código
...
-- Modificar rol para incluir moderador (si tu tabla ya tiene los roles correctos, comenta esta línea)
...
-- =====================================================================
-- 9. TABLA SERVICIOS (legacy - para compatibilidad)
-- =====================================================================
...
-- =====================================================================
-- 10. TABLA SERVICIOS_INFORMATICA
-- =====================================================================
...
-- =====================================================================
-- 13. TABLA ACCIONES_ADMINISTRATIVAS
-- =====================================================================
...
-- =====================================================================
-- 14. TABLA ASIGNACIONES_PROYECTO (compatibilidad con Proyecto.php)
-- =====================================================================
...
-- Moderadores adicionales (contraseña: 1234)
INSERT INTO usuarios (dni, email, nombre, contrase, rol, estado) VALUES
('44444444D', 'moderador1@logisteia.com', 'Carlos Ruiz - Moderador', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'moderador', 'activo'),
('55555555E', 'moderador2@logisteia.com', 'Ana García - Moderadora', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'moderador', 'activo')
ON DUPLICATE KEY UPDATE email = email;
...
-- =====================================================================
-- Tablas eliminadas vs script completo:
-- - avatar, bio (usuarios) - No se usan
-- - fecha_fin_real (proyectos) - No se consulta
-- - precio_por_hora, horas_totales (presupuestos) - No se usan
-- - horas_trabajadas (proyectos) - Se define pero no se usa
-- - registro_horas - Tabla completa (HU futura)
-- - invitaciones - Tabla completa (se usa token_invitacion en miembros_equipo)
-- - historial_baneos - Tabla completa (se usa fecha_baneo en usuarios)
--
-- Total: 14 tablas (vs 17 en el script completo)
-- Ejecutar: mysql -u usuario -p < produccion_optimizada.sql
